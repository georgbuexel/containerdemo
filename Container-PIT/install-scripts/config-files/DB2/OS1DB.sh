...
CREATE LARGE
   ...
   STORAGE EXTENTSIZE 16 OVERHEAD 10.5
   PREFETCHSIZE 16 TRANSFERRATE 0.14
   BUFFERPOOL "FNPEDEFAULTBP"
   DROPPED TABLE RECOVERY ON
;

CREATE LARGE
   TABLESPACE VWINDEX_TS
   PAGESIZE 32 K
   MANAGED BY AUTOMATIC
   STORAGE EXTENTSIZE 16 OVERHEAD 10.5
   PREFETCHSIZE 16 TRANSFERRATE 0.14
...
#db2 -v GRANT USE OF TABLESPACE VWDATA_TS TO user $DB2USER;
#db2 -v GRANT USE OF TABLESPACE VWINDEX_TS TO user $DB2USER;
#db2 -v GRANT USE OF TABLESPACE VWBLOB_TS TO user $DB2USER;
